...
x7b = seq(from=10, to=20, length.out=length(x7a))
x7b
length(x7b)
...
try1 = 1:100
(sample(x=try1, size=12, replace=F, prob = seq(0,1,length.out = 100)))

# Male % approx 60%
y2c = sample(x=y2a, size=100, replace=T, prob=c(70,30))
?sample
y2c
...
quantile(n2, p=c(.1, .7, .8))  #10th & 70th percentile
...
breaks1 = c(0,50,65,70,75,80,85,100)
